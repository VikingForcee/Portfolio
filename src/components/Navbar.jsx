...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/60 dark:bg-slate-900/95 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800 transition-colors duration-300 shadow-sm">
